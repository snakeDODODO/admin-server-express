...
UserRouter.put('/api/user/changeprofile/:id', UserController.changeProfile); // 修改个人资料
UserRouter.put('/api/user/changepassword/:id', UserController.changePassword); // 修改密码
